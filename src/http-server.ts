...
const TOOLS = [
  {
    ...
    description:
      "Full-text search across BWB enforcement decisions (abuse of dominance, cartel, sector inquiries). Returns matching decisions with case number, parties, outcome, fine amount, and GWB articles cited.",
    inputSchema: {
  ...
  },
  {
    ...
    description:
      "Get a specific BWB decision by case number (e.g., 'B6-22/16').",
    inputSchema: {
      type: "object" as const,
      properties: {
  ...
  },
  {
    ...
    description:
      "Search BWB merger control decisions (Fusionskontrolle).",
    inputSchema: {
      type: "object" as const,
      properties: {
  ...
  },
  {
    ...
    description:
      "List all sectors with BWB enforcement activity, including decision and merger counts.",
      ...
      switch (name) {
        ...
        case "at_comp_about": {
          return textContent({
            ...
            version: pkgVersion,
            description:
              "BWB (German Federal Cartel Office) MCP server. Provides access to German competition law enforcement decisions, merger control cases, and sector enforcement data under the GWB (Gesetz gegen Wettbewerbsbeschränkungen).",
            data_source: "BWB (https://www.bundeskartellamt.de/)",
